...
public class AdminHandler {
	...
	//keyword参数放在最后，为空不会报错
	@RequestMapping("/admin/remove/{adminId}/{pageNum}/{adminAcct}/{keyword}.html")
	public String remove(
				@PathVariable("adminId") Integer adminId,
				@PathVariable("pageNum") Integer pageNum,
				@PathVariable("adminAcct") String adminAcct,
				@PathVariable("keyword") String keyword,HttpSession session
			) {
		Admin admin = (Admin) session.getAttribute(CrowdConstant.ATTR_NAME_LOGIN_ADMIN);
		String LoginAcct = admin.getLoginAcct();
		if(Objects.equals(adminAcct, LoginAcct)) {
